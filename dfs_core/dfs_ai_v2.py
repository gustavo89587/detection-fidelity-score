...
# Business Impact
line("Business Impact:", bold=True, dy=16)
line(
    "- O sistema bloqueou execução potencialmente comprometida "
    "antes da fase final de execução de ferramenta.",
    dy=14
)
line(
    "- A progressão de risco foi interrompida automaticamente "
    "ao atingir nível estrutural crítico.",
    dy=18
)
